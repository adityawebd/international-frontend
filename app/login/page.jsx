...
const page = () => {
  ...
  const searchParams = useSearchParams(); // Using this for query parameters
  const redirect = searchParams.get('redirect'); // Getting the 'redirect' query parameter
  ...
  useEffect(() => {
    if (redirectToHome) {
      const redirectTo = redirect || '/'; // Redirect to the referring page or home page
      router.push(redirectTo);
    }
  }, [redirectToHome, redirect, router]);
        ...
        <div className="container">
          ...
          <div className="login_form mt-5" onSubmit={handleSubmit}>
            <form>
              ...
              <a className="text-xs" href="/forget-password">
                Forget Password?
              </a>

              <button type="submit">Login</button>

              <a className="login_register_btn" href="/register">
                register now
              </a>
