        ...
        <div className="flex flex-col justify-center items-center py-5 lg:px-32">
          ...
          <div className="w-full overflow-x-auto mt-4">
            <table className="min-w-full bg-white border border-gray-200">
              <thead>
                <tr>
                  <th className="px-2 md:px-6 py-2 md:py-3 border-b text-left text-xs md:text-sm font-medium text-gray-700">
                    Order ID
                  </th>
                  <th className="px-2 md:px-6 py-2 md:py-3 border-b text-left text-xs md:text-sm font-medium text-gray-700">
                    Channel Order ID
              ...
              <tbody>
                {orderData.map((order, index) => (
                  <tr key={index}>
                    <td className="px-2 md:px-6 py-2 md:py-4 border-b text-xs md:text-sm text-gray-700">
                      {order.order_id}
                    </td>
                    <td className="px-2 md:px-6 py-2 md:py-4 border-b text-xs md:text-sm text-gray-700">
