        ...
        <div className="navbar">
          ...
          <div className="navbar_body">
            ...
            <div className="navbar_icons">
              <div
                className={`cart_icon user_dropdown_btn w-full flex flex-col justify-end items-end ${session ? "-mb-4" : "mb-0" }`}
                  ...
                  {session ? (
                    <div className="flex items-end">
                      <div className="username_after_login">
                        <a className="text-sm no-underline max-sm:-mt-1" href="/profile">
                          {" "}
                    ...
                    results.map((result) => (
                      ...
                      >
                        <img
                          ...
                          className="rounded-lg border"
                        />
                        <div className=" productTitle mt-2 text-sm">
                          {result.title}
                        </div>
                      </a>
                    ))
